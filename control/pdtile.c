                                   ...
                                   PLASMA_sequence *sequence, PLASMA_request *request)
{
    ...
    for (m = 0; m < A.mt; m++)
    {
        ...
        for (n = 0; n < A.nt; n++)
        {
            ...
            f77 = AF77(m, n);
            bdl = ABDL(m, n);
//			CORE_dlacpy(PlasmaUpperLower, (Y2-Y1), (X2-X1), &(f77[X1*lda+Y1]), lda, &(bdl[X1*lda+Y1]), ldt);
            RT_CORE_dlacpy(
                                   ...
                                   PLASMA_sequence *sequence, PLASMA_request *request)
{
    ...
    for (m = 0; m < A.mt; m++)
    {
        ...
        for (n = 0; n < A.nt; n++)
        {
            ...
            f77 = AF77(m, n);
            bdl = ABDL(m, n);
//			CORE_dlacpy(PlasmaUpperLower, (Y2-Y1), (X2-X1), &(bdl[X1*lda+Y1]), ldt, &(f77[X1*lda+Y1]), lda);
            RT_CORE_dlacpy(
                plasma->quark, &task_flags,
                PlasmaUpperLower, (Y2-Y1), (X2-X1), A.mb,
                &(bdl[X1*lda+Y1]), ldt,
