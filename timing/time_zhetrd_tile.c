...
#define _NAME  "PLASMA_zhetrd_Tile"
...
RunTest(int *iparam, double *dparam, real_Double_t *t_) 
{
   ...
   // PLASMA_Complex64_t *Q;
    ...
    PASTE_CODE_ALLOCATE_MATRIX( D, 1, double, N, 1 );
    PASTE_CODE_ALLOCATE_MATRIX( E, 1, double, N, 1 );
    ...
    START_TIMING();
    INFO = PLASMA_zhetrd_Tile( vec, uplo, descA, D, E, descT, Q, LDQ );
    STOP_TIMING();
    if(INFO!=0){
