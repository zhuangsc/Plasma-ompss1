...
RunTest(int *iparam, float *dparam, real_Double_t *t_) 
{
    ...
    /* Allocate Data */
    PASTE_CODE_ALLOCATE_MATRIX_TILE( descA, 1, float, PlasmaRealFloat, LDA, M, NRHS );
    ...
    PASTE_TILE_TO_LAPACK( descA, A2, check, float, LDA, NRHS );
    ...
    if ( check )
    {
        ...
        PASTE_TILE_TO_LAPACK( descA, A, 1, float, LDA, NRHS );
