...
int PLASMA_dgeam(PLASMA_enum transA, PLASMA_enum transB, int M, int N, double alpha, double *A, int LDA, double beta, double *B, int LDB);
...
int PLASMA_dgeam_Tile(PLASMA_enum transA, PLASMA_enum transB, double alpha, PLASMA_desc *A, double beta, PLASMA_desc *B);
...
int PLASMA_dsrtdg_Tile_Async(PLASMA_desc *A, double *work, PLASMA_sequence *sequence, PLASMA_request *request);
int PLASMA_dgeam_Tile_Async(PLASMA_enum transA, PLASMA_enum transB, double alpha, PLASMA_desc *A, double beta, PLASMA_desc *B, PLASMA_sequence *sequence, PLASMA_request *request);
