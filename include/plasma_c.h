...
int PLASMA_cgeam(PLASMA_enum transA, PLASMA_enum transB, int M, int N, PLASMA_Complex32_t alpha, PLASMA_Complex32_t *A, int LDA, PLASMA_Complex32_t beta, PLASMA_Complex32_t *B, int LDB);
...
int PLASMA_cgeam_Tile(PLASMA_enum transA, PLASMA_enum transB, PLASMA_Complex32_t alpha, PLASMA_desc *A, PLASMA_Complex32_t beta, PLASMA_desc *B);
...
int PLASMA_cgeam_Tile_Async(PLASMA_enum transA, PLASMA_enum transB, PLASMA_Complex32_t alpha, PLASMA_desc *A, PLASMA_Complex32_t beta, PLASMA_desc *B, PLASMA_sequence *sequence, PLASMA_request *request);
