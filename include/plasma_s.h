...
int PLASMA_sgeam(PLASMA_enum transA, PLASMA_enum transB, int M, int N, float alpha, float *A, int LDA, float beta, float *B, int LDB);
...
int PLASMA_sgeam_Tile(PLASMA_enum transA, PLASMA_enum transB, float alpha, PLASMA_desc *A, float beta, PLASMA_desc *B);
...
int PLASMA_sgeam_Tile_Async(PLASMA_enum transA, PLASMA_enum transB, float alpha, PLASMA_desc *A, float beta, PLASMA_desc *B, PLASMA_sequence *sequence, PLASMA_request *request);
